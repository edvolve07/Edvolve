...
export const NAV_ITEMS = [
  { href: "/dashboard", label: "Assessment Dashboard", icon: LayoutDashboard, roles: ["student"], modules: ["both", "aptitude", "ai_interview"] },
  { href: "/interview", label: "Interview", icon: Mic2, roles: ["student"], modules: ["both", "ai_interview"] },
  { href: "/aptitude", label: "Aptitude", icon: BrainCircuit, roles: ["student"], modules: ["both", "aptitude"] },
  ...
  { href: "/admin/assessments/create", label: "Create Assessment", icon: FilePlus2, roles: ["admin"], modules: ["both", "aptitude"] },
  { href: "/admin/assessments", label: "Assessments", icon: ClipboardList, roles: ["admin"], modules: ["both", "aptitude"] },
